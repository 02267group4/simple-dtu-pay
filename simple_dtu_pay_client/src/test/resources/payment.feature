Feature: Payment
  ...
  Scenario: Successful payment and Token reuse is rejected
    Given a customer with name "Alice", CPR "121914-1516", and balance 1000
    And a merchant with name "Bob", CPR "239425-2627", and balance 1000
  ...
  Scenario: Payment is rejected when the customer has insufficient funds
    Given a customer with name "Alice", CPR "111911-1121", and balance 50
    And a merchant with name "Bob", CPR "229222-2232", and balance 1000
    And the customer has a valid token
    When the merchant initiates a payment for 100 kr by the customer using the token
    Then the payment is rejected
  ...
  Scenario: Successful Payment with a different amount
    Given a customer with name "Alice", CPR "111911-1121", and balance 1000
    And a merchant with name "Bob", CPR "229222-2232", and balance 1000
    And the customer has a valid token
